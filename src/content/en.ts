...
export const en: Copy = {
  ...
  checkout: {
    ...
    dueAmount: "€0",
    terms:
      "Polar collects the card. €0 today for 14 days. Then €5/month unless you cancel before the 14 days end. After that it renews each month until you cancel in the desk. Amounts in EUR. Polar is the merchant of record.",
    ...
    afterLine: "After day 14 the membership is €5/month until you cancel.",
