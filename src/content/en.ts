...
export const en: Copy = {
  ...
  pricing: {
    kicker: "Pricing",
    h2: "14 days on the calendar. Then €9/month.",
    lead: "14 days free, no card needed. Add one anytime after to keep training at the founding price of €9/month — €19/month is what this normally costs elsewhere.",
    ...
    price: "€9",
    per: "/month",
    blurb: "14 days free, no card. €9/month if you add one after. Cancel anytime.",
    features: [
      "Seven programs from aerobic engine to 100 km and alpine days",
      "No card for 14 days — add one anytime to keep training at €9/month",
      "Cancel during the 14 days and Polar does not charge",
      "Training weeks, not medical claims",
    ],
    laterTitle: "After the 14 days",
    laterBody:
      "Add a card anytime to keep training at €9/month. Nothing is ever charged automatically — without a card, the desk simply pauses until you add one. No other price is listed on this site.",
  },
  checkout: {
    kicker: "Start",
    h2: "Write this week",
    ...
    successBody: "€0 for 14 days. Then €9/month unless you cancel first.",
    daysLeft: "days left of the free trial",
    payTitle: "Add a card to keep training",
    payBody:
      "Your free trial has ended. Add a card to keep training — €9/month unless you cancel first.",
    ...
    dueAmount: "€0",
    terms:
      "Polar collects the card. €0 today for 14 days. Then €9/month unless you cancel before the 14 days end. After that it renews each month until you cancel in the desk. Amounts in EUR. Polar is the merchant of record.",
    ...
    afterLine: "After day 14 the membership is €9/month until you cancel.",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "What does €9/month mean?",
        a: "That is the founding price for everyone who joins now — €19/month is what this level of training normally runs elsewhere. You keep €9/month for as long as you stay subscribed. No card is needed to start — add one anytime to keep training past day 14.",
      },
      {
        q: "Can I cancel?",
      ...
      },
      {
        ...
        a: "If you have not added a card, the desk pauses until you add one — nothing is charged automatically. If you did add a card, it continues at €9/month unless you cancel first.",
      },
      {
        q: "Do I need a card for the trial?",
        a: "No. Start free for 14 days without one. Add a card anytime, during or after the trial, to keep training at €9/month.",
      },
      {
  ...
  foundingPage: {
    ...
    trial: "14 days free. No card needed. Add one anytime to keep training after.",
    note: "No card needed for 14 days. Add one anytime after to keep training at €9/month. That is the only price listed here.",
    back: "← Ridgework home",
    title: "Founding invite, Ridgework",
    description: "Weekly training. 14 days free, then €9/month. Cancel anytime.",
  },
  termsPage: {
    title: "Terms of Service",
    updated: "Last updated: September 2026",
    body: [
      "Ridgework writes training weeks for trail and mountain. Not medical care, no diagnoses. Price: 14 days free, no card needed. Add a card anytime after to keep training at €9/month (support@ridgework.org). You remain responsible for training and mountain safety. Mandatory consumer rights under French/EU law are not limited.",
      "Service. Ridgework provides weekly training plans for trail and mountain. It is not medical care and makes no diagnoses.",
      "Price and trial. Current price is €9/month, after 14 free days. No card is needed to start. If you add a card and stay after those 14 days, Polar charges €9/month. Without a card, nothing is ever charged automatically — the desk pauses at day 14 until you add one. That is the only listed price.",
  ...
  appPage: {
    ...
    testBanner: "14 days free, no card needed. Then €9/month if you add one.",
