...
export const planEn: PlanToolsCopy = {
  ...
  sessions: {
    ...
    vert: "Uphill walk/jog",
    mountain: "Mountain day",
    sharpness: "Short strides",
...
export const planFi: PlanToolsCopy = {
  ...
  sessions: {
    easy: "Kevyt kävely/hölkkä",
    steady: "Tasainen",
    long: "Pitkä kevyt",
    quality: "Tehovedot",
    vert: "Nousu kävellen/hölkäten",
    mountain: "Vuoripäivä",
    sharpness: "Lyhyet rytinät",
    recovery: "Palauttava kävely",
    rest: "Lepo",
    hike: "Vaellus",
    pack: "Rinkkakävely",
    engine: "Matala syke",
...
export const planFr: PlanToolsCopy = {
  ...
  sessions: {
    easy: "Marche / footing facile",
    steady: "Soutenu",
    long: "Longue facile",
    quality: "Intervalles",
    vert: "Montée marche / footing",
    mountain: "Journée montagne",
    sharpness: "Courtes accélérations",
    recovery: "Récup marche",
    rest: "Repos",
    hike: "Rando",
    pack: "Marche avec sac",
    engine: "Pouls bas",
    climb: "Escalade",
    strength: "Force",
...
export const planDe: PlanToolsCopy = {
  ...
  sessions: {
    easy: "Gehen / lockeres Joggen",
    steady: "Stetig",
    long: "Langer lockerer",
    quality: "Intervalle",
    vert: "Bergauf gehen / joggen",
    mountain: "Bergtag",
    sharpness: "Kurze Steigerungen",
    recovery: "Erholung gehen",
    rest: "Ruhe",
    hike: "Wanderung",
    pack: "Pack-Gang",
