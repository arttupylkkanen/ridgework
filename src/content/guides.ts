...
export const GUIDES: GuideCopy[] = [
  ...
  },
  {
    ...
    title: {
      en: "Easy base: more minutes at a pace you can talk",
      fi: "Peruskunto: lisää minuutteja vauhdilla jolla puhut",
      fr: "Base : plus de minutes à une allure où vous parlez",
      de: "Grundlagenausdauer: mehr Minuten in einem Tempo, in dem du sprechen kannst",
    },
    description: {
      en: "No race required. The block most people skip. A sweaty hour every time does not make you fitter.",
      fi: "Kisaa ei tarvita. Jakso jonka useimmat ohittavat. Hikinen tunti joka kerta ei kasvata.",
      fr: "Pas besoin de course. Le bloc que la plupart sautent. Une heure suante à chaque sortie ne suffit pas.",
      de: "Kein Rennen nötig. Der Block, den die meisten überspringen. Eine schwitzige Stunde jedes Mal macht dich nicht fitter.",
    },
    kicker: {
    ...
    body: {
      en: [
        "If you do not have a race, you still have a peak: more minutes where you can speak in full sentences, and a long that grows toward 90 minutes without turning into a sufferfest.",
        "Ridgework’s easy-base program is sixteen weeks of that. No separate hard session — the easy volume is the work. If you cannot speak, you are too fast.",
        "A sweaty hour every time is the usual mistake. Eat normally. Keep the long conversational. Save sugar for when the outing actually needs it.",
        ...
        "Jos ei ole kisaa, peak on silti: enemmän minuutteja joilla saat kokonaisia lauseita, pitkä kohti 90 min ilman kärsimysnäytelmää.",
        "Peruskunto-ohjelma on kuusitoista viikkoa sitä. Ei erillistä tehoa — helppo volyymi on työ. Jos et puhu, olet liian lujaa.",
        "Hikinen tunti joka kerta on tavallinen virhe. Syö normaalisti. Pidä pitkä puhevauhdissa.",
        "Tämä jakso on pohja kaikille muille ohjelmille. Ylimääräiset viikot ennen 50 tai 100 km istuvat tässä.",
      ],
      fr: [
        "Sans course, le pic reste : plus de minutes à l’allure conversation, une longue vers 90 min.",
        "Le programme base : seize semaines. Pas de séance dure à part — le volume facile est le travail. Si vous ne parlez pas, vous allez trop vite.",
        "Une heure suante à chaque sortie est l’erreur habituelle. Mangez normalement. Gardez la longue conversationnelle.",
        "Ce bloc est aussi la base sous tous les autres programmes.",
      ],
      de: [
        "Ohne Rennen bleibt der Peak: mehr Minuten im Gesprächspuls, Langer Richtung 90 Min.",
        "Grundlagenausdauer: sechzehn Wochen. Keine extra harte Einheit — das lockere Volumen ist die Arbeit. Keine Sätze = zu schnell.",
        "Eine schwitzige Stunde jedes Mal ist der übliche Fehler. Iss normal. Halt den Langen gesprächig.",
