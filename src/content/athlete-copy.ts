...
export const athleteFi: AthleteCopy = {
  ...
  today: {
    ...
    fatigue: "Väsymys",
    stress: "Stressi",
    scaleLow: { sleep: "Surkea", soreness: "Ei ole", motivation: "Ei ole", fatigue: "Virkeä", stress: "Rauha" },
    scaleHigh: { sleep: "Erinomainen", soreness: "Kova", motivation: "Kova halu", fatigue: "Rikki", stress: "Korkea" },
...
const reasonsFr: Record<string, string> = {
  ...
  runToHikeCycle: "Vous ne pouvez pas courir : les jours aérobies deviennent de la rando ou du vélo.",
...
export const athleteFr: AthleteCopy = {
  onboarding: {
    ...
    disciplines: { trail: "Trail", ultra: "Ultra", alpine: "Alpin / escalade", road: "Route", ski: "Ski-mo" },
    experience: {
    ...
    longest: { m60: "< 60 min", m90: "60–90 min", m150: "90–150 min", m240: "2,5–4 h", m240p: "> 4 h" },
    terrain: {
      flat: "Surtout plat",
  ...
  today: {
    ...
    fatigue: "Fatigue",
    stress: "Stress",
    scaleLow: { sleep: "Mauvais", soreness: "Aucune", motivation: "Aucune", fatigue: "Frais", stress: "Calme" },
    scaleHigh: { sleep: "Excellent", soreness: "Sévère", motivation: "Envie", fatigue: "Cassé", stress: "Haut" },
    ...
    calls: {
      ...
      easy: { title: "Facile ou récupération", action: "Conversationnel seulement. Pas de qualité." },
...
export const athleteDe: AthleteCopy = {
  onboarding: {
    ...
    disciplines: { trail: "Trail", ultra: "Ultra", alpine: "Alpin / Klettern", road: "Straße", ski: "Ski-Mo" },
    experience: {
  ...
  today: {
    ...
    fatigue: "Müdigkeit",
    stress: "Stress",
    scaleLow: { sleep: "Schlecht", soreness: "Keiner", motivation: "Keine", fatigue: "Frisch", stress: "Ruhig" },
    scaleHigh: { sleep: "Ausgezeichnet", soreness: "Stark", motivation: "Lust", fatigue: "Kaputt", stress: "Hoch" },
