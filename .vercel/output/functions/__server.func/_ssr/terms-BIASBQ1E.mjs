...
import { D as isPathLocale, i as Route$4, w as getCopy } from "./router-Crh4553Z.mjs";
import { n as SiteShell } from "./site-shell-D6MlXv5o.mjs";
import { t as LegalPage } from "./legal-page-Dz0pvwyJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/terms-BIASBQ1E.js
var import_jsx_runtime = require_jsx_runtime();
function Page() {
	const { locale: raw } = Route$4.useParams();
