import { n as getPglite, t as ensureDbReady } from "./db-CWLrYAZJ.mjs";
import { $ as encode, $n as createLogger, A as jwtVerify, At as array, Bn as ATTR_OPERATION_ID, C as serializeSignedCookie, D as decodeJwt, E as base64Url, Ft as number, Gn as queueAfterTransactionHook, Hn as safeJSONParse, It as object, Jn as getBetterAuthVersion, Kn as runWithAdapter, Ln as withSpan, Lt as optional, Mt as email, O as decodeProtectedHeader, Pt as looseObject, Qn as createRandomStringGenerator, Rn as ATTR_CONTEXT, Rt as record, S as serializeCookie, St as betterFetch, Tt as normalizePathname, Un as getAuthTables, Vn as import_src, Wn as getCurrentAdapter, Xn as initGetFieldName, Yn as initGetModelName, Zn as generateId, _ as runWithRequestState, a as createAuthorizationURL, b as createRouter$1, c as createRateLimitKey, cr as isTest, d as deprecate, dr as kAPIErrorHeaderSymbol, dt as JWTExpired, er as logger, f as createAuthEndpoint, fr as BASE_ERROR_CODES, g as hasRequestState, h as defineRequestState, i as refreshAccessToken, jt as boolean, k as importJWK, kt as any, l as findInvalidTrustedProxies, lr as APIError, m as isAPIError, n as socialProviders, o as applyDefaultAccessTokenExpiry, or as isDevelopment, p as createAuthMiddleware, qn as runWithTransaction, r as validateAuthorizationCode, rr as env, s as isLoopbackHost, sr as isProduction, t as SocialProviderListEnum, tr as shouldPublishLog, u as getIp, ur as BetterAuthError, v as getCurrentAuthContext, w as filterOutputFields, x as toResponse, y as runWithEndpointContext, zn as ATTR_HOOK_TYPE, zt as string } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BoaqzEkN.js
...
var PRODUCTION_ORIGINS = ["https://ridgework.org", "https://www.ridgework.org"];
var extraTrustedOrigins = (env$1("GROK_AUTH_TRUSTED_ORIGINS") ?? "").split(/[\s,]+/).filter(Boolean);
